...
//$MerchantID='PLANETC';  //$checksumKey='c8tXLHQAB8Oh'; // testing bill desk credential
$MerchantID='JEEOGURU';
$checksumKey='TjaOAZTjyiby';
...
$newData = "$MerchantID|$orderID|NA|$TxnAmount|NA|NA|NA|$CurrencyType|NA|R|jeeoguru|NA|NA|F|$userid|$userEmail|$payment_for|$partnerid|NA|NA|NA|$url";
$checksum = hash_hmac('sha256',$newData,$checksumKey,false);
