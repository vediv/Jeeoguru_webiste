...
<?php require_once 'includes/navigation.php';?> 
    ...
    <div class="w3-row darkBar">
        <div class="main-container w3-row-padding ">
            <ol class="w3-breadcrumb"><li><a href="<?php echo $baseUrl?>/home">HOME</a> / </li><li><li><a class="last"> Subscription and Cancelation</a></li></ol>
        </div>    
  </div>
     ...
     <div class="w3-row fullHeight">
         <div class="main-container w3-row-padding" style="min-height: 200px;">
             <div class="w3-col darkBg " id="Policy-data"> 
                 <div class="font-size"> <?php echo $applicationName?>  Subscription and Cancelation</div> <br /> 
                 <?php include_once 'pages/payment.php';?> 
             </div>    
