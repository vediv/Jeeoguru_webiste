...
?>
<body onload="initEpisode(<?php echo $patID; ?>)" id="get_token">
...
<!--<li><a href="subcategory" class="last">subcategory</a></li>--></ol>
    ...
    <!-- Home setting---->
      <div class="w3-row fullHeight ">
        ...
        <div class="s12 m12 l12" width="100%" id="category-image_epi">
   ...
   <div class="w3-seprator-top"></div>
       <div class="w3-row ">
            ...
            <div class="s6 m6 l6  w3-row-padding " id="subcategory-image1">
...
$.post(GET_CATEGORY_DATA, {page: track_click,partnerid:PARTNER_ID,categoryid:catIdNew,limit:limit,countrycode:countrycode}, function(JSONresponse){
  ...
  var resultShow=build_episode(JSONobject);
  $("#subcategory-image1").html(resultShow);
  $("#button_load").show();
  track_click++;
 });
...
$(".load_more").click(function (e) { //user clicks on button
        ...
        if(track_click <= total_pages) //make sure user clicks are still less than total pages
        {
                ...
                $("#subcategory-image1").append(resultShow); //append data received from server
