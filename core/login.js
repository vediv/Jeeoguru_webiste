...
function userlogin(userEmail,userpassword,authprovider,type,os,uuid,name)
{
     ...
     var Container = "login_fail";
          ...
          type=deviceType; name=user_browser;os=user_os; uuid=token;authprovider='Application';
...
function UserSignUp(userName,userEmail,userPassword,code,newsletter,userDob)
{
    ...
    type=deviceType; name=user_browser;os=user_os;uuid=token;
...
function buildLoginHtml(container)
{
  ...
  var html='';
    ...
    html+='<div class="w3-col m12 l12 w3-image" style=""><a href="'+baseUrl+'/index" class="w3-wide  logo1 "><img src="http://www.jeeoguru.com/images/logo_header_lg.png"></a>';
    html+='</div>';
