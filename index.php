    ...
    <div class="w3-row height-carousal">
          ...
          <img class="w3-image" width="100%" src="images/placeholderjeeoguru.png">
           ...
           <div style="margin-left:20% !important;">
            <a  href="javascript:" onclick="bannerclick('<?php echo $loginflag; ?>')"> <img width="70%"  src="images/add_banner.png"></a>
          </div>
...
function bannerclick(lstatus)
{
  if(lstatus=='N'){
    login();
  }
  if(lstatus=='Y'){ window.location=baseUrl+'/subscription';}
}
</script>
