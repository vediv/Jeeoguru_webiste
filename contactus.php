...
<body onload="initicket()" id="get_token">
   ...
   <?php require_once 'includes/navigation.php';?>
      ...
      <div class=" w3-margin-top  w3-col s12 m12 l12">
        ...
        <p class="w3-text-white font-size1  letter-spacing  w3-justify" style="letter-spacing: 0.021em;">Jeeoguru is the India's leading subscription service and streaming popular movies,exclusive web series,exclusive short films,songs and many more exclusive videos along with a live channel with varieties of shows anywhere in world and anytime with a free subscription for most of the videos.</p>
		</div>
      <br />
          <hr class="hrstyle">
