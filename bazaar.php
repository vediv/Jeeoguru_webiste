...
<body onload="initbazar()" id="get_token">
   ...
   <!-- !slider----->
    ...
    <div class="w3-row ">
        <div class="main-container w3-row-padding ">
            <div class="s12 m12 l12 card-holder w3-row-padding darkBg card-holder" id="bazar_result">
  ...
  <div class="w3-col s6 m1 l1 w3-center padd_cont" id="button_load">
   <button class="load_more w3-button w3-left  w3-green1 font-form  padding-both w3-round" id="load_more_button" style=" margin-bottom:20px !important">load more</button>
  </div>
   <div class="w3-col s5 m5 l5">&nbsp;</div>
...
var catIdNew=sessionStorage.getItem("bazaar_id");
...
$(".load_more").click(function (e) { //user clicks on button
        ...
        if(track_click <= total_pages) //make sure user clicks are still less than total pages
        {
                ...
                $("#bazar_result").append(resultShow); //append data received from server
