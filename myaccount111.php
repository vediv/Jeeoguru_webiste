...
<div class="w3-row channel-container" style="min-height: 100%;">
    <div class="main-container ">
        ...
        <div class="w3-col s12 m10 l10 w3-row-padding">
            <div id="profile" class="tabs card-holder w3-card-2 border-radius4 w3-col" style="padding:0px; ">
              
                <div class="border-radiusTop4 w3-red"><h3>Profile</h3><p><small>Edit your profile</small></p></div>
            ...
            <div id="password" class="tabs displayNone card-holder w3-card-2 border-radius4">
                <div class="w3-row-padding" style="padding:0px;"> 
                    <div class="w3-red border-radiusTop4"><h3>Password</h3><p><small>Update your password</small></p></div>
            ...
            <div id="plan" class="tabs displayNone card-holder  w3-card-2 border-radius4">
                  <div class="w3-row-padding" style="padding:0px"> 
                      <div class="w3-red border-radiusTop4"><h3>Subscription Plan</h3><p><small>Plan details</small></p></div>
               
                
                    <div class="w3-col m12 l12 s12 ">
                        <h4>CURRENT SUBSCRIPTION</h4>
                        <table class=" w3-responsiv planTable" border="1" bordercolor="#2A2A2A">
                            <tr class="header"><td>Plan</td><td>Period</td><td>Rate</td><td>Date</td><td>Expiry</td><td>Status</td></tr>
                            <tr ><td>Monthly</td><td>30 days</td><td>Rs 100</td><td>10 March</td><td>10 April</td><td><i class="fa fa-circle w3-text-red"></i></td></tr>
...
{
    var tab='<button class="w3-button w3-btn  border-radius4" id="tabprofile" onclick=openTab("profile")><i class="fa fa-user fa-2x"></i></button>';
        tab+='<button class="w3-button w3-btn  border-radius4" id="tabpassword" onclick=openTab("password")><i class="fa fa-lock fa-2x"></i></button>';
        tab+='<button class="w3-button w3-btn  border-radius4" id="tabplan" onclick=openTab("plan")><i class="fa fa-credit-card " ></i></button>';
        
        
        _("w3-bar").innerHTML=tab;
        _("tab"+activeId).classList.remove("w3-red");   
        _("tab"+activeId).classList.add("w3-red");   
